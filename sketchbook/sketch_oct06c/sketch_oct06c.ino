#include <SPI.h>
// pin 51 MOSI (i.e. data)
// pin 50 MISO
// pin 52 SCK i.e. clock
...
void setup()
{
    ...
    pinMode(mc_micro_shiftreg_latch, OUTPUT);
    pinMode(synth_latch, OUTPUT);
